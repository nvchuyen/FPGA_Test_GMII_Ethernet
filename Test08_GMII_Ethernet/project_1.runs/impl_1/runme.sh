...
HD_PWD='E:/Xilinx/Artix-7/Workspace-DDR3-DB2/Test08_GMII_Ethernet/project_1.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log ethernet_test.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source ethernet_test.tcl -notrace
