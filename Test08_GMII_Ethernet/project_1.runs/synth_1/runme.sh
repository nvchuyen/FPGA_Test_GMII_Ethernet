...
HD_PWD='E:/Xilinx/Artix-7/Workspace-DDR3-DB2/Test08_GMII_Ethernet/project_1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log ethernet_test.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source ethernet_test.tcl
